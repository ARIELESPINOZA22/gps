        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h2>Registrar</h2>
                                <form action="paisInsertar.php" method="POST">

                                    <input type="hidden" class="form-control mb-3" name="idPais" placeholder="numero de id del campo pais">
                                    <input type="text" class="form-control mb-3" name="nombre" placeholder="Nuevo Pais">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="paisActualizar.php?id=<?php echo $row['idPais'] ?>" class="btn btn-info">Editar</a></td>
                                                <td><a href="paisDelete.php?id=<?php echo $row['idPais'] ?>" class="btn btn-danger">Eliminar</a></td>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
